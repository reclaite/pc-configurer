...
public class Eldorado {
    ...
    public static void main(String[] args) throws IOException {
        Connection.Response response = Jsoup.connect("https://www.eldorado.ru/sem/v3/a711/products?rootRestrictedCategoryId=0&query=amd%20ryzen%205%205600x&orderField=popular&limit=36&regionId=15591&strategy=sold_amount_relevance&soldAmountBoost=0.5")
        ...
        System.out.println(new GsonJsonParser().parseMap(response.body()).get("data"));
    }
